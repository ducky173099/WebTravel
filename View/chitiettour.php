						...
						<!-- <div class="frame-info pos-relative">
							...
							<div class="bg-phone hidden-md hidden-sm hidden-xs">
								<img src="images/bg-phone.png" alt="phone">
									...
									<!-- <span id="multiplication" class="RateAdultAvg ismultiplication">x</span> -->
						...
						<div class="tourFormPrice">
							...
							<!-- <div class="flex_item col-xs-12 no-padding v-margin-bottom-15">
								...
								<div class="btn-group groupPlusAndSub">
									...
									<button type="button" onClick="onInCreaseChild()" class="btn number-button plus-adult btn-general">
										<i class="fa fa-plus"></i>
									</button>
								</div>
							</div> -->
								...
								<div class="form-group no-margin">
									...
									<div class="col-xs-12 no-padding scroll-mobile">
										...
										<div class="col-xs-12 no-padding check-Button">
											<button onClick="onShowPrice()" class="btn btn-flat btn-action btn-md btn-block checkButton requestPrice">Xem giá</button>
										</div>
